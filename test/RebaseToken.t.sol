...
contract RebaseTokenTest is Test{
    ...
    function testDepositLinear(uint256 amount) public {
        ...
        console.log(startingBalance, "starting Balance");
    ...
    function testCannotCallMintAndBurn() public {
        // Get the interest rate first, before setting up the revert expectation
    ...
    function testInterestRateCanOnlyDecrease(uint256 newInterestRate) public {
        ...
        vm.prank(owner);
        vm.expectPartialRevert(bytes4(RebaseToken.RebaseToken__InterestRateCanOnlyBeDecreased.selector));
        rebaseToken.setInterestRate(newInterestRate);
